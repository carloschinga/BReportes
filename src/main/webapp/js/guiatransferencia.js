        ...
        if (sec1 !== "" || sec2 !== "" || fechainicio !== "" || fechafin !== "") {
            ...
            var table = $('#table-secuencias').DataTable({
                ...
                "columns": [
                    ...
                    , {"data": "obsmov", "render": function (data, type, row) {
                            return data ? data : '';
                        }
                    },
                    {"data": "destino"},
                    {"data": "usado", "render": function (data, type, row) {
                            ...
                            return '<button type="button" class="btn btn-primary btn-sm" data-invnum="' + row.invnum + '" data-toggle="tooltip" data-placement="top" title="Ver lista de productos"><i class="fas fa-list"></i></button>';
                        }
                    }
                ]
            });
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        if (jsonResponse.resultado === "ok") {
                            alert("Picking asignado con codigo: " + jsonResponse.codpik);
                            $.fn.listarsecuencias();
                        } else {
                            alert("error");
                        }

 ...
 * @author LOQ
 */
@WebServlet(name = "RecetasCRUD", urlPatterns = {"/RecetasCRUD"})
public class RecetasCRUD extends HttpServlet {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                if (emprObj != null) {
                    ...
                    HechRecetasCliJpaController dao = new HechRecetasCliJpaController("d");
                    switch (opcion) {
                        case "1"://listar pacientes segun las recetas
                            String data = dao.listarpacientesDNI();
                        ...
                        case "2"://listar
                            ...
                            out.print("{\"resultado\":\"ok\",\"data\":" + dao.listar_diagnostico(body) + "}");
                            break;
                        case "3"://listar pacientes segun las recetas
                            String actomedico = request.getParameter("actomedico");
                            data = dao.listarfarmacos(Integer.parseInt(actomedico));
                            out.print("{\"resultado\":\"ok\",\"data\":" + data + "}");
                            break;
                        default:

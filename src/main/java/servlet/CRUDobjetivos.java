 ...
 * @author shaho
 */
@WebServlet(name = "CRUDobjetivos", urlPatterns = { "/CRUDobjetivos" })
public class CRUDobjetivos extends HttpServlet {
        ...
        try (PrintWriter out = response.getWriter()) {
            try {
                ...
                if (emprObj != null) {
                    ...
                    ObjeventasJpaController dao = new ObjeventasJpaController(empr);
                    ...
                    switch (opcion) {
                        ...
                        case "2":// listar para los checkbox
                            ...
                            res.append(dao.listarLaboratorioJson(codobj));
                            res.append(",\"tip\":");
                            res.append(dao.listarTipoJson(codobj));
                            res.append(",\"sis\":");
                            res.append(dao.listarsiscodJson(codobj));
                            res.append(",\"estr\":");
                            res.append(dao.listarEstrategicoJson(codobj));
                            res.append(",\"estrsolo\":");
                            res.append(dao.listarEstrategicoSoloJson(codobj));
                            res.append(",\"productos\":");
                            res.append(dao.listarProductosJson(codobj));
                            res.append("}");
                        ...
                        case "3":// agregar
                            ...
                            if (codobj != 0) {
                                Objeventas obj = new Objeventas(codobj);
                                obj.setDesobj(data);
                                ...
                                data = json.get("lab").toString();
                                dao.actualizar_productos(codobj, "lab", data, null);
                                data = json.get("tip").toString();
                                dao.actualizar_productos(codobj, "tip", data, null);
                                data = json.get("esta").toString();
                                String resultado = dao.actualizar_productos(codobj, "estab", data, mesano);
                                data = json.get("estra").toString();
                                dao.actualizar_productos(codobj, "estra", data, null);
                                data = json.get("estrasolo").toString();
                                dao.actualizar_productos(codobj, "estrasolo", data, null);
                        ...
                        case "4":
                            ...
                            Objeventas obj = dao.findObjeventas(codobj);
                            if (obj == null) {
                        ...
                        case "8":// listar establecimientos monto
                            codobj = Integer.parseInt(request.getParameter("codobj"));
                            out.print("{\"resultado\":\"ok\",\"data\":" + dao.listarsiscodmontos(codobj) + "}");
                            break;

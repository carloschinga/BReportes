...
import dao.EstrategicoJpaController;
 ...
 * @author shaho
 */
@WebServlet(name = "CRUDEstrategico", urlPatterns = {"/CRUDEstrategico"})
public class CRUDEstrategico extends HttpServlet {
        ...
        try (PrintWriter out = response.getWriter()) {
            try {
                ...
                if (emprObj != null) {
                    ...
                    EstrategicoJpaController dao = new EstrategicoJpaController(empr);

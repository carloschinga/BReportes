 ...
 * @author USUARIO
 */
@WebServlet(name = "CRUDUbicar", urlPatterns = { "/ubicarMasivo" })
public class CRUDUbicar extends HttpServlet {
    ...
    protected void doPut(HttpServletRequest req, HttpServletResponse resp)
        ...
        try {
            ...
            for (int i = 0; i < productos.length(); i++) {
                ...
                try {
                    AlmacenesBartolitoDetalle detaRegi = dao.buscarOneuDetallePorLoteAlmacenProducto(lote, alma,
                            codpro);
                    ...
                    registro.put("cantidad_nueva_e", canteDeta + qtymov);
                    registro.put("cantidad_nueva_f", cantfDeta + qtymov_m);
                    registro.put("estado", "ACTUALIZADO");
                    registro.put("error", JSONObject.NULL);

                    detaRegi.setCante(canteDeta + qtymov);
                    detaRegi.setCantf(cantfDeta + qtymov_m);
                    dao.edit(detaRegi);
